...
import loaderStyles from "../styles/GlobalLoader.module.css"; // Import the loader styles
...
const Dashboard: React.FC = () => {
  ...
  // Define feedback messages based on user level
  const feedbackMessages = {
    ...
    intermediate: [
      "You're making great progress! Try refining your responses.",
    ...
    advanced: [
      "Amazing work! You've completed all scenarios!",
  ...
  // Get feedback messages based on the number of badges unlocked
  ...
  const handleFeedbackSubmit = () => {
    if (feedbackInput.trim().toLowerCase() === "feedback") {
      ...
      setFeedbackInput(""); // Clear the input field after submission
    }
  };
              ...
              <div className={styles.statBlock}>
                ...
                <p className={styles.statValue}>
                  <span className={styles.stars}>
                    {badgesUnlocked >= 1 && <img src="/images/star-medal.png" alt="star" className={styles.starImage} />}
                    {badgesUnlocked >= 2 && <img src="/images/star-medal.png" alt="star" className={styles.starImage} />}
                    {badgesUnlocked >= 3 && <img src="/images/star-medal.png" alt="star" className={styles.starImage} />}
                  </span>
                </p>
              </div>
